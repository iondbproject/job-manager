...
## Command line arguments for various make scenarios ###########################
...
libsources := $(SRC)/iondb/kv_io.c \
              $(SRC)/iondb/ion_file.c \
              $(SRC)/iondb/ion_master_table.c \
              $(SRC)/iondb/linkedfilebag.c \
              $(SRC)/iondb/dictionary.c \
              $(SRC)/iondb/slhandler.c \
              $(SRC)/iondb/slstore.c \
              $(SRC)/iondb/oadictionaryhandler.c \
              $(SRC)/iondb/oahash.c \
              $(SRC)/iondb/ffdictionaryhandler.c \
              $(SRC)/iondb/flatfile.c \
              $(SRC)/iondb/oafdictionaryhandler.c \
              $(SRC)/iondb/oafhash.c \
              $(SRC)/iondb/bpptree.c \
              $(SRC)/iondb/bpptreehandler.c \
              $(SRC)/jsmn/jsmn.c \
              $(SRC)/millisec.c \
              $(SRC)/jobmanager.c
...
tlsources   := $(TESTS)/unit/jobmanager.c \
               $(TESTS)/CuTest.c
...
testsources := $(TESTS)/unit/run_jobmanager.c
